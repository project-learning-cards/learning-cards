    ...
    >
      <div className={s.information}>
        <div className={s.avatarBlock}>
          <div>
            <Image className={s.imagesPI} src={fileURL ? fileURL : props.avatar} />
          </div>
          <input className={s.inputStyleAdd} ref={inRef} type={'file'} onChange={upload} />
          <Button
