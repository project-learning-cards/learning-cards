  ...
  return (
    <Modal
      ...
      footer={[
        ...
        !isChecked && (
          <Button key="submit" type="primary" onClick={() => setIsChecked(true)}>
            Show answer
          </Button>
        ),
        isChecked && (
          <Button key="submit" type="primary" onClick={() => onNext(grade, card._id)}>
            Next
          </Button>
        ),
      ]}
        ...
        {isChecked && (
          <div className={s.answerBlock}>
            ...
            <div className={s.answer}>
              <b>Rate yourself:</b>
              <SuperRadio name={'radio'} value={grade} options={grades} onChangeOption={setGrade} />
            </div>
          </div>
        )}
      </div>
