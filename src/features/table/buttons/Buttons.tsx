      ...
      {props.type === 'pack' && (
        <>
          <div className={s.btnsWrapper}>
            {width! > 1040
              ? props.user_id === props.userId && (
                  <>
                    ...
                    <Button className={s.learnButton} onClick={() => props.deletePackFun!(props.id)}>
                      {t('delete')}
                    </Button>
                  </>
                )
            ...
            <Button className={s.learnButton} onClick={() => setShowLearnModal(true)}>
              {t('learn')}
            </Button>
          </div>
